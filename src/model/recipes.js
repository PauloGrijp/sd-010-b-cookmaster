...
const createNewRicipe = async (name, ingredients, preparation, user) => {
...
const updateRecipeId = async ({ recipeId, name, ingredients, preparation, user }) => {
  const db = await connection();
